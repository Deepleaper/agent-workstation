...
**Agent 工位模板库 — 100 个自带进化起点的专业角色，不是从零开始**
...
不是空壳模板。每个角色自带 **Brain Seed（知识种子）**——Agent 不是从零开始，而是带着行业知识出生，然后通过 learn → recall → evolve 持续自进化。<br/>
...
**AI Agent Role Template Library — 100 roles with built-in evolution starting points**
